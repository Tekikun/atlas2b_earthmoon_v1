...
C CAN BE CHANGED
      ...
      cabezal2='     <R>-R_min  width(Re)  sigma_0       periods(?unit)'
...
C LIMITS IN SEMIMAJOR AXIS
      WRITE(*,*)'interval to be analyzed in R_EARTH: Re_min,Re_max?'
      WRITE(*,*)'(example: 2,25.4)'
      READ(*,*)A2MIN,A2MAX
...
C G is gravitational constant in (kg, km, s), mass_earth in kg, R_earth in km, DAY in second
      ...
      R_EARTH = 6378.137
      DAY = 86400
C      KGAUS=0.01720209895D0 # for heliocentric
C      KG2=KGAUS**2
...
C MASS OF THE STAR IN UNIT MASS
      MST=XM0
